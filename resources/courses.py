...
def course_or_404(course_id):
    try:
        ...
        abort(404, {"error": "Course {0} does not exists".format(course_id)})
    else:
        return course
...
class CourseList(Resource):
    def __init__(self):
        ...
        self.reqparse.add_argument(
            'url', required=True, help="No valid course URL provided", location=['form', 'json'], type=inputs.url)
        super().__init__()
